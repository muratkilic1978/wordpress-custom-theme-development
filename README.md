...
?>
```
12. Now go and open **index.html** template file again with your favorite editor.
Cut out following code from **index.html** :
...
```
13. Go and open **index.php** file inside your WordPress custom theme folder *wp-content/themes/university-theme*. Delete everything between *get_header()* and *get_footer()* - check the code below.
```PHP
<?php get_header(); ?>
...
<?php get_footer(); ?>
```
14. Now go and paste the content from previous *step number 12*. in between **get_header()** and **get_footer()** and save the file.
