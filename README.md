...
7. Go to line *66* that begins with _$table_prefix  = 'wp\_'_ and override the text inside the quote that says _'wp_'_ with a table-prefix name eg. **wp_custom-theme**.
